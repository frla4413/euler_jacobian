...
\begin{example}[label={ex:outline},listing only,%
  listing options={style=siamlatex,{morekeywords=[1]{maketitle},
      morekeywords=[2]{siamonline190516}},}]%
  {Document outline}
...
\documentclass[supplement]{siamonline190516}
\input{ex_shared}
...
\item Change in file names: \texttt{siamonline181217.cls} is replaced by
  \texttt{siamonline190516.cls}, and the \texttt{siam.bst} bibliography style
...
\cref{ex:numbering} as documentclass options (e.g., \code{\documentclass[review,onefignum,onetabnum]} \code{{siamonline190516}}).
